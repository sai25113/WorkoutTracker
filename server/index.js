    ...
    const seedExercises = [
      {
        ...
        breathing: 'Inhale as you lower into the squat, exhale as you stand up.'
      },
      {
      ...
      },
      {
        ...
        breathing: 'Inhale as you lower the weight, exhale as you extend your arms.'
      }
...
app.get('/api/exercises', async (req, res) => {
  try {
    ...
    const rows = await Exercises.find(query)
      .sort({ created_at: -1 })
      .toArray();
    res.json(rows);
  } catch (err) {
